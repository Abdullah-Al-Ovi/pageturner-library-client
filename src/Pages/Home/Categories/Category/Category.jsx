...
const Category = ({category}) => {
    ...
    return (
        <div className="">
             <div className="border-2 rounded-md p-3 flex flex-col bg-gradient-to-r from-blue-200 via-purple-200 to-pink-200 ">
                ...
                <div className="text-center my-3">
                    <Link><button className="btn">See Books</button></Link>
                </div>
