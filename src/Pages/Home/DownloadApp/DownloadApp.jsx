        ...
        <section className={`bg-white  ${!isLight && 'darkcss'}`}>
            <div className={`container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row `}>
                <div className="flex justify-center xl:w-1/2">
                    <img className="h-80 w-80 sm:w-[28rem] sm:h-[28rem] flex-shrink-0 object-cover rounded-full" src={appLogo} />
                </div>
        
                <div className={`flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0  ${!isLight && "text-white"}`}>
                    <h2 className={`text-2xl font-semibold tracking-tight  xl:text-3xl ${!isLight && "text-white"}`}>
                        Download our free mobile app
                    </h2>
        
                    <p className={`block max-w-2xl mt-4  ${!isLight && "text-white"}`}>Download our mobile app to access a world of convenience at your fingertips. Whether you&rsquo;re on the go or at home, our app provides a seamless and user-friendly experience, giving you quick access to our services, products, and exclusive offers.</p>
